...
class SentInvitesModal extends StatelessWidget {
  const SentInvitesModal({
    Key? key,
  }) : super(key: key);
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            const YSpace(12),
            CustomText(
                "You have ${cv.circle.friends.where((element) => element.senderId == uv.user!.userid && !element.accepted).length} sent circle invite(s)",
                height: 1.4,
                size: 14),
            const YSpace(24),
            Expanded(
